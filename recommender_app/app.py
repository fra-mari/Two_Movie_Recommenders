...
def rec_page():
    ...
    logging.warning("The movie rating generated by the user's input have been added to 'data_and_models/data/preprocessed/ready_dataset.csv'.")
...
def knn_page():
    ...
    logging.warning("New KNN recommendations generated based on the user's input. No update possible to 'data_and_models/data/preprocessed/ready_dataset.csv'.")
